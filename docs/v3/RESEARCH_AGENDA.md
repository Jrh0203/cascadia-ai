...
|---|---|---|---|
| 1 | Canonical battery of adopted default (rebaseline block) | RUNNING (~04:15) | descriptive reference + fresh serving-default ledgers; never evidence |
| 2 | R1.3b menu-widening screen (`--max-actions 512`) | armed behind #1 | regret ≤ −0.010 vs incumbent ⇒ champion-tier sequential CUPED gate; else R1.3b closes |
