#!/usr/bin/env python3
"""Compare ADR 0108 repair origin and replay scientific payloads."""
...
def compare_reports(
    ...
    if (
        ...
        raise ValueError("unexpected ADR 0108 experiment identity")
    ...
    if (
        ...
        raise ValueError("ADR 0108 origin/replay group identity differs")
