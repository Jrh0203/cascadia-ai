#!/usr/bin/env python3
"""Compare ADR 0112 origin and replay scientific payloads."""
...
def compare_reports(
    ...
    if (
        ...
        raise ValueError("unexpected ADR 0112 experiment identity")
    ...
    if (
        ...
        raise ValueError("ADR 0112 origin/replay group identity differs")
