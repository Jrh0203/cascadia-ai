#!/usr/bin/env python3
"""Compare ADR 0109 neural origin and replay scientific payloads."""
...
def compare_reports(
    ...
    if (
        ...
        raise ValueError("unexpected ADR 0109 experiment identity")
    ...
    if (
        ...
        raise ValueError("ADR 0109 origin/replay group identity differs")
