...
TRAIN_OUT="${TRAIN_OUT:-cascadiav3/fixtures/crt_merit_train.jsonl}"
TRAIN_MANIFEST="${TRAIN_MANIFEST:-cascadiav3/fixtures/crt_merit_train_manifest.json}"
VAL_OUT="${VAL_OUT:-cascadiav3/fixtures/crt_merit_val.jsonl}"
VAL_MANIFEST="${VAL_MANIFEST:-cascadiav3/fixtures/crt_merit_val_manifest.json}"

TRAIN_FIRST_SEED="${TRAIN_FIRST_SEED:-2026063000}"
TRAIN_SEED_COUNT="${TRAIN_SEED_COUNT:-100}"
VAL_FIRST_SEED="${VAL_FIRST_SEED:-2026069000}"
...
REPORT="${REPORT:-cascadiav3/reports/crt_merit_pilot.json}"
CHECKPOINT="${CHECKPOINT:-cascadiav3/checkpoints/crt_merit_pilot.pt}"
...
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=cascadiav3/src python -m cascadiav3.torch_action_query_merit \
  --train '$TRAIN_OUT' \
  --val '$VAL_OUT' \
  --steps '$STEPS' \
...
rsync -az "$REMOTE:$REMOTE_ROOT/cascadiav3/fixtures/crt_merit"* cascadiav3/fixtures/
