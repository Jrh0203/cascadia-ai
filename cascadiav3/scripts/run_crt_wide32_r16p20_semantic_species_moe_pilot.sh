...
export TRAIN_MODULE="${TRAIN_MODULE:-cascadiav3.torch_semantic_species_moe_merit}"
export EXPERIMENT_ID="${EXPERIMENT_ID:-crt-wide32-r16p20-semantic-species-moe-v1}"

export LOSS_MODE="${LOSS_MODE:-standard}"
export REPORT="${REPORT:-cascadiav3/reports/crt_wide32_r16p20_semantic_species_moe_pilot.json}"
export CHECKPOINT="${CHECKPOINT:-cascadiav3/checkpoints/crt_wide32_r16p20_semantic_species_moe_pilot.pt}"
export EXTRA_TRAIN_ARGS="${EXTRA_TRAIN_ARGS:- --summary-out cascadiav3/reports/crt_wide32_r16p20_semantic_species_moe_pilot_summary.md --expert-scale 0.5}"
