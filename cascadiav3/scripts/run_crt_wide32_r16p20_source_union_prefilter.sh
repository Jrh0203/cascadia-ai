...
REPORT="${REPORT:-cascadiav3/reports/crt_wide32_r16p20_semantic_source_union_prefilter.json}"
SUMMARY_OUT="${SUMMARY_OUT:-cascadiav3/reports/crt_wide32_r16p20_semantic_source_union_prefilter_summary.md}"
EXPERIMENT_ID="${EXPERIMENT_ID:-crt-wide32-r16p20-semantic-source-union-prefilter-v1}"
...
PYTHONDONTWRITEBYTECODE=1 PYTHONPATH=cascadiav3/src python -m cascadiav3.torch_prefilter_union_eval \
  --train '$TRAIN' \
  --val '$VAL' \
