...
SUPPORT_SHA256="${SUPPORT_SHA256:?set SUPPORT_SHA256}"
...
SOURCE="${ROOT}/tools/derive_hex_dual_observation_bounds.py"
SUPPORT="${ROOT}/tools/derive_hex_bipartite_edge_bounds.py"
OUTPUT_DIR="${ROOT}/cascadiav3/fleet_outputs/${FLEET_TAG}"
LOG_DIR="${ROOT}/cascadiav3/logs"
OUTPUT="${OUTPUT_DIR}/shard_${SHARD_HOST}.json"
HEARTBEAT="${LOG_DIR}/hex_dual_${FLEET_TAG}_${SHARD_HOST}.heartbeat"
EXIT_FILE="${LOG_DIR}/hex_dual_${FLEET_TAG}_${SHARD_HOST}.exit"
CHILD_PID_FILE="${LOG_DIR}/hex_dual_${FLEET_TAG}_${SHARD_HOST}.solver.pid"
WRAPPER_PID_FILE="${LOG_DIR}/hex_dual_${FLEET_TAG}_${SHARD_HOST}.pid"
...
observed_support="$(shasum -a 256 "$SUPPORT" | awk '{print $1}')"
