...
export TRAIN_MODULE="${TRAIN_MODULE:-cascadiav3.torch_semantic_cross_attention_merit}"
export EXPERIMENT_ID="${EXPERIMENT_ID:-crt-wide32-r16p20-semantic-cross-attention-v1}"
...
export REPORT="${REPORT:-cascadiav3/reports/crt_wide32_r16p20_semantic_cross_attention_pilot.json}"
export CHECKPOINT="${CHECKPOINT:-cascadiav3/checkpoints/crt_wide32_r16p20_semantic_cross_attention_pilot.pt}"

"$SCRIPT_DIR/run_crt_relation_bias_pilot.sh"

REPORT="cascadiav3/reports/crt_wide32_r16p20_semantic_cross_attention_prefilter_eval.json" \
PER_ROOT_OUT="cascadiav3/reports/crt_wide32_r16p20_semantic_cross_attention_prefilter_eval_roots.jsonl" \
CHECKPOINT="$CHECKPOINT" \
VAL="$VAL_OUT" \
EXPERIMENT_ID="crt-wide32-r16p20-semantic-cross-attention-prefilter-eval-v1" \
